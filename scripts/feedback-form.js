...
function sendfeedbackemail(submitElement) {
	...
	researchName = document.getElementsByClassName("research__name")[0].value;
	researchEmail = document.getElementsByClassName("research__email")[0].value;

	var thebody = feedbackName + "<br><br>"+feedbackEmail+"<br><br>"+ researchName + "<br><br>"+ researchEmail + "<br><br>"+feedbackBody.replace(/(?:\r\n|\r|\n)/g, '<br>')
